  ...
  _createClass(AsciiMathParser, [{
    ...
    value: function other_constant() {
      ...
      if (not) {
        ...
        try {
          for (var _iterator7 = this.relations[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
            ...
            var m = this.exact(sym.asciimath, not.end);
      ...
      try {
        for (var _iterator8 = this.constants[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
          var _sym = _step8.value;

          var _m = this.exact(_sym.asciimath, pos);
...
var _asciimath2tex = _interopRequireDefault(require("./asciimath2tex"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

var parser = new _asciimath2tex["default"]();
